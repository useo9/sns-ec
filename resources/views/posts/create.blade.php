<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">投稿を作成</h2>
    </x-slot>
                ...
                <form method="POST" action="{{ route('posts.store') }}"
                    ...
                    <div>
                        ...
                        <label class="mt-1 block cursor-pointer">
                            {{-- プレビュー表示エリア --}}
                            <div x-show="preview"
                                 class="relative w-full rounded-lg overflow-hidden bg-gray-100"
                                 style="display:none">
                                <img :src="preview" class="w-full max-h-72 object-cover">
                                <span class="absolute inset-0 flex items-center justify-center
                                             bg-black/30 opacity-0 hover:opacity-100 transition text-white text-sm font-medium">
                                    画像を変更
                                </span>
                            </div>
                            ...
                            <div x-show="!preview"
                                 class="mt-1 flex flex-col items-center justify-center gap-2
                                        ...
                                        rounded-lg hover:border-gray-400 transition text-gray-400">
                    ...
                    <div>
                        <div class="flex justify-between items-center">
                            ...
                            <span class="text-xs text-gray-400" x-text="bodyLength + ' / 1000'"></span>
                        </div>
